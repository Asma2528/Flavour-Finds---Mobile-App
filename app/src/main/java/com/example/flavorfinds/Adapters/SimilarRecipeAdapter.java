package com.example.flavorfinds.Adapters;
...
import com.example.flavorfinds.R;
...
public class SimilarRecipeAdapter extends RecyclerView.Adapter<SimilarRecipeViewHolder>{
    ...
    public void onBindViewHolder(@NonNull SimilarRecipeViewHolder holder, int position) {
        ...
        Picasso.get().load("https://img.spoonacular.com/recipes/"+list.get(position).id+"-556x370."+list.get(position).imageType).into(holder.imageViewSimilar);
